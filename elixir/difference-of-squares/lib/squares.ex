defmodule Squares do
  ...
  def sum_of_squares(number), do: 1..number |> Enum.map(&square/1) |> Enum.sum
  ...
  def square_of_sum(number), do: 1..number |> Enum.sum |> square
  ...
  defp square(n), do: :math.pow(n, 2) |> round
end
